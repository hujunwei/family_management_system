...
public class MyBatisPlusCodeGenTests {
    @Test
    public void testGenerator() {
        ...
        globalConfig.setAuthor("lian")
                .setOutputDir("D:\\Repo\\IdeaProject\\family_management_system\\family_service_platform\\src\\main\\java")//设置输出路径
        ...
        dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver").setUrl("jdbc:mysql://127.0.0.1:3306/family_service_platform?useSSL=false&useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC")
